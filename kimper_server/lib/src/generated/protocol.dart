...
import 'currency.dart' as _i3;
import 'example.dart' as _i4;
import 'exchange.dart' as _i5;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    t ??= T;
    if (t == _i3.Currency) {
      return _i3.Currency.fromJson(data) as T;
    }
    if (t == _i4.Example) {
      return _i4.Example.fromJson(data) as T;
    }
    if (t == _i5.Exchange) {
      return _i5.Exchange.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i3.Currency?>()) {
      return (data != null ? _i3.Currency.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i4.Example?>()) {
      return (data != null ? _i4.Example.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i5.Exchange?>()) {
      return (data != null ? _i5.Exchange.fromJson(data) : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i3.Currency) {
      return 'Currency';
    }
    if (data is _i4.Example) {
      return 'Example';
    }
    if (data is _i5.Exchange) {
      return 'Exchange';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    if (data['className'] == 'Currency') {
      return deserialize<_i3.Currency>(data['data']);
    }
    if (data['className'] == 'Example') {
      return deserialize<_i4.Example>(data['data']);
    }
    if (data['className'] == 'Exchange') {
      return deserialize<_i5.Exchange>(data['data']);
    }
